...
actual class DeviceInfo actual constructor(){
    ...
    @OptIn(ExperimentalForeignApi::class)
    actual val screenWidth = CGRectGetWidth(UIScreen.mainScreen.bounds).toInt()
    @OptIn(ExperimentalForeignApi::class)
    actual val screenHeight = CGRectGetHeight(UIScreen.mainScreen.bounds).toInt()
